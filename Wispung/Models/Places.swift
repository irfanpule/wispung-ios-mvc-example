...
var places: [Place] = [
    ...
    Place(photo: UIImage(named: "Danau-Ranau")!, name: "Danau Ranau",
          ...
          operatingHours: "24 jam", location: "Lampung Barat, Lampung"),
    // 2
    Place(photo: UIImage(named: "Gunung-Anak-Krakatau")!, name: "Gunung Anak Krakatau",
          ...
          operatingHours: "05.00-15.00", location: "Selat Sunda"),
    // 3
    Place(photo: UIImage(named: "Air-Terjun-Putri-Malu")!, name: "Air Terjun Putri Malu",
          ...
          operatingHours: "06.00-18.00", location: "Juku Batu, Banjit, Kabupaten Way Kanan, Lampung"),
    // 4
    Place(photo: UIImage(named: "Pantai-Dewi-Mandapa")!, name: "Pantai Dewi Mandapa",
          ...
          operatingHours: "08.00-22.00", location: "Gebang, Padang Cermin, Kabupaten Pesawaran, Lampung"),
    // 5
...
""", operatingHours: "08.00-18.00", location: "Dusun Tanjung Raya, Kampung Kota Way Kecamatan Kasui, Kabupaten Way Kanan, Lampung"),
    // 6
...
""", operatingHours: "24 jam", location: "Dusun Purwajaya, Desa Sumberjaya, Kecamatan Padang Cermin, Kabupaten Pesawaran, Lampung"),
    // 7
    Place(photo: UIImage(named: "Bukit-Pangonan")!, name: "Bukit Pangonan",
          ...
          operatingHours: "08.00-18.00", location: "Jl. Raya Danau, Fajar Esuk, Kec. Pringsewu, Kabupaten Pringsewu, Lampung"),
    // 8
...
""", operatingHours: "24 Jam", location: "Perkebunan Karet PTPN VII Afdeling Bergen, Purwodadi Dalam, Kecamatan Tanjung Bintang, Lampung Selatan, Lampung"),
    // 9
...
""", operatingHours: "24 jam", location: "Desa Pegadungan, Kecamatan Kelumbayan, Kabupaten Tanggamus, Lampung"),
    // 10
...
""", operatingHours: "24 jam", location: "Suoh, Lampung Barat, Provinsi Lampung")
]
